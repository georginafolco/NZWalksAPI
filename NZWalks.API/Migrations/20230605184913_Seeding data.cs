    ...
    public partial class Seedingdata : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("0045adeb-56a8-423a-a188-9b75770946d4"), "Medium" },
                    { new Guid("6ff1eaf5-a738-4072-8c42-54d746a69f10"), "Easy" },
                    { new Guid("94f0aee2-a719-4ff3-aa04-7e0772928da8"), "Hard" }
                });
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.DeleteData(
                table: "Difficulties",
                keyColumn: "Id",
                keyValue: new Guid("0045adeb-56a8-423a-a188-9b75770946d4"));

            migrationBuilder.DeleteData(
                table: "Difficulties",
                keyColumn: "Id",
                keyValue: new Guid("6ff1eaf5-a738-4072-8c42-54d746a69f10"));

            migrationBuilder.DeleteData(
                table: "Difficulties",
                keyColumn: "Id",
                keyValue: new Guid("94f0aee2-a719-4ff3-aa04-7e0772928da8"));
